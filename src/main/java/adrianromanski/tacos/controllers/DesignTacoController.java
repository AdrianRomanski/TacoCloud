...
import adrianromanski.tacos.model.Ingredient;
import adrianromanski.tacos.model.Ingredient.Type;
...
public class DesignTacoController {
    ...
    public String showDesignFormat(Model model) {
        List<Ingredient> ingredients = Arrays.asList(
                ...
                new Ingredient("CARN", "maet", Type.PROTEIN),
                new Ingredient("TMTO", "diced tomatoes", Type.VEGGIES),
                new Ingredient("LETC", "lettuce", Type.VEGGIES),
                new Ingredient("CHED", "cheddar", Type.CHEESE),
                new Ingredient("JACK", "Monterey Jack", Type.CHEESE),
                new Ingredient("SLSA", "hot tomato sauce", Type.SAUCE),
